...
/**
 * Send a text message to a WhatsApp newsletter channel.
 * Uses proto-encoded conversation message via sock.query.
 * Note: Media messages (images) are not supported on newsletter channels
 * via Baileys - only text messages deliver reliably.
 */
